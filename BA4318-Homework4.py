...
consumptionlist = [6, 3, 3, 14,2,0]
dictionary = { "Company" : companylist, " Payment": paymentlist ,"Consumption":consumptionlist}

print("Company:", dictionary["Company"][0])
paymentlist= [ "Cash-Daily Menu","Credit-Dailey Menu","Cash-Coffee","Credit-Coffee","Cash-Dessert","Credit-Dessert"]
consumptionlist = [2, 2, 1, 3, 0,0]
zipped = zip(paymentlist,consumptionlist)
for payment,order in zipped:
    print(payment, " quantity equals to ",order)      
